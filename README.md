...
To add a new log, simply run journalApp "<Your message here...>". 
  ...
  * journalApp must be in your path; by default, it is installed in $CMAKE_SOURCE_DIR/bin. If the executable is not in your path, then providing the full to it still allows to execute it correctly, although doing it this way is annoying.
